...
def browseAndSave(page, targetURL, save_path, timeout_0=6500, timeout_1=2500): # more countdowns? let's see.
    ...
    page.wait_for_selector("html", timeout_2 = 1000) # thing will not even show up. no navigation. fuck?
